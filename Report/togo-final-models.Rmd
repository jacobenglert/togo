...
Here I've included an interactive 3D visualization of the impact of latitude and longitude on both models. While I cannot share the data, feel free to download the models from the `Output` folder and run the following code to create your own versions of these to play around with.
